...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(239,68,68,0.22),transparent_34%),linear-gradient(135deg,#09090b_0%,#18181b_45%,#030712_100%)] p-6 text-zinc-50">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <header className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-2xl backdrop-blur">
          <div className="absolute right-6 top-6 h-24 w-24 rounded-full bg-red-500/20 blur-3xl" />
          <div className="relative flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            <div className="rounded-2xl border border-white/10 bg-zinc-950/70 px-4 py-3 text-right shadow-inner">
              ...
              <div className="font-mono text-2xl font-bold text-red-400">{year}</div>
            </div>
          </div>
        </header>
